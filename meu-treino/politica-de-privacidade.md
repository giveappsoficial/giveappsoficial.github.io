...
<p>O aplicativo Meu Treino utiliza o <strong>Firebase Authentication</strong> para permitir que os usuários criem contas ou utilizem o app de forma anônima. É possível fazer login com:</p>
<ul>
  <li>Conta Google</li>
...
<ul>
  <li>Planos de treino criados pelo usuário</li>
  <li>Treinos e exercícios vinculados aos planos</li>
  <li>Dados de séries, pesos, repetições e tempo de descanso</li>
...
<h3>Notificações</h3>
<p>O aplicativo pode enviar notificações relacionadas a:</p>
<ul>
  <li>Lembretes de dias de treino</li>
  <li>Treinos iniciados e não concluídos</li>
  <li>Tempo de descanso atingido durante um exercício</li>
</ul>

<p>Essas notificações são configuradas localmente no aplicativo e não requerem o compartilhamento de dados com terceiros.</p>

<h2>Retenção e Exclusão de Dados</h2>

<h3>Retenção</h3>
<p>Os dados dos usuários são armazenados no Firestore enquanto a conta estiver ativa ou enquanto o usuário continuar utilizando o app. Dados vinculados a contas anônimas também são armazenados até que sejam removidos manualmente ou até que a conta seja excluída.</p>

<h3>Exclusão</h3>
<p>Você pode solicitar a exclusão de sua conta e de todos os seus dados armazenados. Após a solicitação, seus dados serão permanentemente excluídos do Firestore Database.</p>

<p><strong>Em breve, uma página com instruções detalhadas será disponibilizada.</strong></p>
...
<p>O aplicativo Meu Treino é destinado exclusivamente a <strong>usuários maiores de 18 anos</strong>. Não coletamos intencionalmente dados pessoais de menores de idade. Se você for pai, mãe ou responsável e acreditar que seu filho menor de 18 anos utilizou o aplicativo e forneceu dados pessoais, entre em contato conosco. Tomaremos as medidas necessárias para remover essas informações de nossos servidores.</p>
